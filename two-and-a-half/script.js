const questions = [
    ...
    { question: "Attention! Attention: You've finished your warm-ups!", type: "communication", message: "Special thanks to you for playing this game! From here onwards, it is the actual scavenger hunt! Please read the questions, they will hint at a digital location where I have left the code. Enter that code to move forward" },
    { question: "Scavenger Hunt 1 (Hint: Video): We were obsessed with some trivial, every day things. A (fake) friend of yours took advantage of that and you felt right into her trap.",type: "input", correct: "utantanu" },
    { question: "Scavenger Hunt 2 (Hint: Image): Wandering in the harsh flurries and the brisk wind between Bangkok, Seoul, and Beijing, we found the irresitable ball of snow.", type: "input", correct: "tinimonbong"  },
    { question: "Scavenger Hunt 3 (Hint: Image): Head tilted. Arms wrapped. Leaned our back on the Six", type: "input", correct: "imsofat"  }
